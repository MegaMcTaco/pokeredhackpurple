...
GiovanniData:
	...
	db "GIOVANNI@",$FF,45,RHYDON,42,ONIX,44,NIDOQUEEN,45,NIDOKING,50,KANGASKHAN,0
...
AgathaData:
	db "AGATHA@",$FF,56,ARBOK,56,UMBREON,55,HOUNDOOM,58,GOLBAT,60,GENGAR,0
	
LanceData:
	db "LANCE@",$FF,58,GYARADOS,56,CHARIZARD,56,SEADRA,60,AERODACTYL,62,DRAGONITE,0	
...
EngineerData:
	...
	db "FLINT@",21,MAGNEMITE,VOLTORB,0
...
SwimmerData:
	...
	db "BEN@",32,GOLDEEN,SEAKING,STARMIE,0
...
PsychicData:
	...
	db "KIO@",33,SLOWPOKE,SLOWBRO,PSYDUCK,0
	db "RHEN@",38,GOLDUCK,0
...
BirdKeeperData:
	...
	db "JIM@",26,DODRIO,SPEAROW,DODUO,FEAROW,0
	db "ERIC@",29,PIDGEOTTO,FEAROW,0
	db "CHRIS@",28,SPEAROW,SKARMORY,FEAROW,0
...
RocketFData:
RocketData:
	db "EXECUTIVE@",$FD,EXECUTIVE_F,15,RATTATA,ZUBAT,0
...
PkmnTrainerData:
    db "FLANNERY@",$FE,FLANNERY,COOLTRAINER_F,33,SCYTHER,33,LAPRAS,36,VENONAT,0
