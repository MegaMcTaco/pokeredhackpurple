...
if DEF(_YELLOW)
	...
	db 9,WEEDLE,0
	db 18,CATERPIE,BEEDRILL,BUTTERFREE,0
	;Fighting Dojo
	db 47,HERACROSS,SCIZOR,0
	db 40,SCYTHER,0
	db 40,PINSIR,0
	db 36,BEEDRILL,BUTTERFREE,0
	db 31,ARIADOS,VENOMOTH,PARASECT,0
	db 40,SPINARAK,ARIADOS,0
	db 43,PARASECT,0
	db 38,CATERPIE,METAPOD,BUTTERFREE,0
	db 43,WEEDLE,KAKUNA,BEEDRILL,0 
endc
	...
	db 30,SPINARAK,ARIADOS,HERACROSS,0
if DEF(_YELLOW)
...
BlackbeltData: ; 3a1be (e:61be)
	db 47,SCYTHER,PINSIR,0
	db 31,VENONAT,PARAS,PARASECT,0
	db 32,BEEDRILL,BUTTERFREE,0
	db 36,VENOMOTH,0
	db 31,HERACROSS,ARIADOS,VENOMOTH,0
	db 40,SPINARAK,ARIADOS,0
	db 43,HERACROSS,0
	db 38,CATERPIE,METAPOD,BUTTERFREE,0
	db 43,WEEDLE,KAKUNA,BEEDRILL,0
...
if DEF(_YELLOW)
	...
	db $FF,30,GOLEM,34,RHYHORN,29,PERSIAN,32,KANGASKHAN,0
	db $FF,37,NIDOKING,40,KANGASKHAN,42,RHYDON,45,NIDOQUEEN,45,ONIX,0
	db $FF,59,KANGASKHAN,63,PERSIAN,61,NIDOQUEEN,61,NIDOKING,66,RHYDON,60,GOLEM,0
endc
...
BrunoData: ; 3a3a9 (e:63a9)
	db $FF,68,PRIMEAPE,69,ONIX,70,HITMONCHAN,70,HITMONLEE,72,POLIWRATH,73,MACHAMP,0
BrockData: ; 3a3b5 (e:63b5)
if DEF(_YELLOW)
	db $FF,10,GEODUDE,12,ONIX,0
else
	db $FF,10,GEODUDE,12,KABUTO,12,SANDSLASH,14,ONIX,0
endc
MistyData: ; 3a3bb (e:63bb)
	db $FF,16,GOLDEEN,18,SEEL,19,STARYU,21,STARMIE,0
LtSurgeData: ; 3a3c1 (e:63c1)
if DEF(_YELLOW)
	db $FF,28,RAICHU,0
else
	db $FF,22,MAGNETON,24,ELECTRODE,24,ELECTABUZZ,26,RAICHU,0
endc
ErikaData: ; 3a3c9 (e:63c9)
if DEF(_YELLOW)
	db $FF,30,TANGELA,32,WEEPINBELL,32,GLOOM,0
else
	db $FF,29,VICTREEBEL,24,TANGELA,29,VILEPLUME,30,EXEGGUTOR,27,PARASECT,0
endc
KogaData: ; 3a3d1 (e:63d1)
if DEF(_YELLOW)
	db $FF,44,VENONAT,46,VENONAT,48,VENONAT,50,VENOMOTH,0
else
	db $FF,34,WEEZING,34,MUK,37,VENOMOTH,43,SCYTHER,40,ARBOK,0
endc
BlaineData: ; 3a3db (e:63db)
if DEF(_YELLOW)
	db $FF,48,NINETALES,50,RAPIDASH,54,ARCANINE,0
else
	db $FF,45,CHARMELEON,46,FLAREON,48,MAGMAR,50,NINETALES,52,RAPIDASH,54,ARCANINE,0
endc
SabrinaData: ; 3a3e5 (e:63e5)
if DEF(_YELLOW)
	db $FF,50,ABRA,50,KADABRA,50,ALAKAZAM,0
else
	db $FF,55,KADABRA,55,MR_MIME,58,HYPNO,50,DROWZEE,60,ALAKAZAM,0
endc
...
if DEF(_YELLOW)
	...
	db $FF,89,FEAROW,87,ALAKAZAM,87,JOLTEON,85,ARCANINE,91,OMASTAR,93,BLASTOISE,0
	db $FF,89,FEAROW,87,ALAKAZAM,87,JOLTEON,85,ARCANINE,91,OMASTAR,93,VENUSAUR,0
	db $FF,89,FEAROW,87,ALAKAZAM,87,JOLTEON,85,ARCANINE,91,OMASTAR,93,CHARIZARD,0
endc
LoreleiData: ; 3a4bb (e:64bb)
	db $FF,66,DEWGONG,67,CLOYSTER,67,SLOWBRO,66,JYNX,69,LAPRAS,0
...
AgathaData: ; 3a516 (e:6516)
	db $FF,74,LICKITUNG,72,GOLBAT,73,GASTLY,75,HAUNTER,72,ARBOK,77,GENGAR,0
LanceData: ; 3a522 (e:6522)
	db $FF,79,SEADRA,79,DRAGONAIR,81,GYARADOS,81,AERODACTYL,83,CHARIZARD,85,DRAGONITE,0
