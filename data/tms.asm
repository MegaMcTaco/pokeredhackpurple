TechnicalMachines: ; 13773 (4:7773)
	...
	db BLIZZARD ;TM14 - Location: Pokemon Mansion
	...
	db SOLARBEAM ;TM22 - Location: Pokemon Mansion 
	db SLASH ;TM23 - used to be Dragon Rage - Location: Rocket Game Corner 
	db THUNDERBOLT ;TM24 - Location: Prize for defeating Lt. Surge
	db THUNDER ;TM25 - Location: Powerplant 
	db EARTHQUAKE ;TM26 - Location: Silph. Co 
	db FISSURE ;TM27 - Location: Prize for defeating Giovanni
	db DIG ;TM28 - Location: Cerulean City
	...
	db SELFDESTRUCT ;TM36 - Location: Silph. Co 
	...
	db REST ;TM44 - Location: S.S. Anne 
	db THUNDER_WAVE ;TM45 - Location: Route 24
	db PSYWAVE ;TM46 - Location: Prize for defeating Sabrina
	db HYDRO_CANNON ;TM47 - used to be Explosion - Location: Victory Road
